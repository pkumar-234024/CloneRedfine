...
const formwidhtstyle = {
    width: '23rem',
}

const formwidhtstyle2 = {
    'letter-spacing': '1px',
}
    ...
    <div className="row">
      <div className="col-sm-6 text-black">
        ...
        <div className="px-5 ms-xl-4">
          <i className="fas fa-crow fa-2x me-3 pt-5 mt-xl-4" style={logostyle}></i>
          <span className="h1 fw-bold mb-0">Logo</span>
        </div>

        <div className="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">

          <form style={formwidhtstyle}>

            <h3 className="fw-normal mb-3 pb-3" style={formwidhtstyle2}>Log in</h3>
      ...
      <div className="col-sm-6 px-0 d-none d-sm-block">
        <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/img3.webp"
          alt="Login image" className="w-100 vh-100" style={imgstyle2}/>
      </div>
    </div>
  </div>
</section>
